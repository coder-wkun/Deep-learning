...
i = 1
xmldir = "D:\\VOC2007\\Annotations"
outxmldir = "D:\\VOC2007\\2"
imgsdir = "D:\\VOC2007\\JPEGImages"
outdir = "D:\\VOC2007\\1"
for xmlfile in os.listdir(xmldir):
    ...
    for pngfile in os.listdir(imgsdir):
        ...
        if pngname == xmlname:
            ...
            newdir = os.path.join(os.path.abspath(outdir), str(i) + ".jpg")
            ...
            new_xmldir = os.path.join(outxmldir, str(i) + '.xml')
            # 打开并写入
            with open(old_xmldir, 'w',encoding = 'utf-8') as fh:
                dom.writexml(fh)
