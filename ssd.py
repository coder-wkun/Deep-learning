...
class SSD(object):
    _defaults = {
        ...
        # --------------------------------------------------------------------------#
        #"model_path": 'logs/ep100-loss1.790-val_loss3.118.pth',
        # "model_path": 'logs/ep050-loss2.143-val_loss3.985.pth',
        "model_path": 'logs/ep100-loss1.760-val_loss1.974.pth',
    ...
    def detect_image(self, image):
        ...
        for i, c in list(enumerate(top_label)):
            ...
            label_s = '{} {}'.format(area, s)
            draw = ImageDraw.Draw(image)
            label_size = draw.textsize(label, font)
            label = label.encode('utf-8')
            print(label, top, left, bottom, right,s)
            ...
            draw.text((left,bottom), str(label_s), fill=(255, 0, 0), font=font)
